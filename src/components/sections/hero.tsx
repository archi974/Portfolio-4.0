...
import { TypingText } from "@/components/ui-kit/typingText";
    ...
    <section className="relative overflow-hidden pt-16 pb-20 sm:pt-24 lg:pt-28 lg:pb-28">
      ...
      <Container className="relative grid items-center gap-14 lg:grid-cols-[1.05fr_1fr] lg:gap-20">
        <div>
          ...
          >
            Product Designer spécialisé en UX/UI, je conçois des interfaces accessibles
            et intuitives, de la recherche utilisateur jusqu'au prototype interactif.
            Grâce à mes compétences en React, Next.js et TypeScript, je collabore
            efficacement avec les équipes de développement pour transformer les besoins
            utilisateurs en produits concrets.
          </motion.p>
          ...
          >
            {[
              { value: "UX/UI", label: "Design centré utilisateur" },
              { value: "React", label: "Compétences Front-end" },
              { value: "WCAG", label: "Accessibilité" },
            ].map((stat) => (
              <div key={stat.label}>
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-border shadow-lift">
            <img
              src={heroImage}
              alt="Présentation de plusieurs maquettes d'applications et interfaces conçues en Product Design"
              width={1408}
              height={1104}
              fetchPriority="high"
